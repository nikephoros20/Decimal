...
Реализация собственной библиотеки s21_decimal.h. Совместная разработка, полный список участников доступен по запросу.

В этом проекте реализована библиотека s21_decimal.h на языке программирования С. Эта библиотека добавляет возможность работы с типом «decimal», который отсутствует в стандарте языка.
